...
using Nintex.OIDC.STS.Models.ManageViewModels;
using Nintex.OIDC.STS.Models;
using Nintex.OIDC.STS.Services;
using Microsoft.Extensions.Localization;
using Nintex.OIDC.STS.Resources;
using System.Reflection;
using System.Collections.Generic;
using Newtonsoft.Json;
using Microsoft.AspNetCore.WebUtilities;

namespace Nintex.OIDC.STS.Controllers;
...
public class ManageController : Controller
{
    ...
    public async Task<IActionResult> SendVerificationEmail(IndexViewModel model)
    {
        ...
        await _emailSender.SendEmail(
            model.Email,
            "Nintex.OIDC.STS Verification Email",
    ...
    private string GenerateQrCodeUri(string email, string unformattedKey)
    {
        return string.Format(
            ...
            _urlEncoder.Encode("Nintex.OIDC.STS"),
